      ...
      >
        <Box sx={style} style={{height:'250px'}}>
          ...
          <div style={{textAlign: 'center', marginBottom: '3%', display:'flex', width: '100%', justifyContent: 'space-evenly'}}>
            ...
            <button style = {{width: "35%", height: '50px', borderRadius: '30px', cursor: 'pointer', border: 'none', backgroundColor: '#08f26e', fontSize: '18px', fontWeight: 'bold', marginTop: '10%'}}>Adicionar ao carrinho</button>
          </div>        
